...
export function Title({text}: {text: string}) {
  return (
    <div className="w-full flex flex-row items-center justify-center gap-3">
      <div className="grow h-1 rounded-full bg-gradient-to-r from-indigo-300 to-sky-300"></div>
      ...
      <div className="grow h-1 rounded-full bg-gradient-to-r from-sky-300 to-indigo-300"></div>
    </div>
  );
}